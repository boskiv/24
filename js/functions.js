...
$( "#zakazform_home" ).submit(function( event ) {
	...
	var $form = $( this ),
		...
		email_zakaz_home = $form.find( "input[name='email_zakaz_home']" ).val(),
		message_zakaz_home = $form.find( "input[name='message_zakaz_home']" ).val(),
