...
<meta content="pAfyKqCCIcoVLBo/zu1MFKwf8A8t1aTOJu8TfP3XIaTbA90gAVepDPQXhMYCFzytcm36PA7AikWBIZVjK48ICA==" name="csrf-token" />
...
<ul class="dropdown-menu">
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="inpOR3+y+9rprD7RGQ7iZRLGFH1UOkCEXp9YffsS+3E6GyMD0joEi60a3dJdD58DZpPA9taFYrYFsLC9sLo8Rg==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="oXJ9xK8R7htZNPcvXQ93Ppv4DN8JQCgP2MNy70pZvdfV/DpEuo5QkVzFrA7nOUzuID1DdyY+SXZD+jXHAkz65g==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="2253830" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/PHPMailer/PHPMailer/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="AdoLDjsUAiwk59Ck9tCcIzapx4T9Zhw/iOH8OwsuKlmznZ2tnqulx21hTl2o872PP2HYDAbgmMvCpRJAn9nm4A==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/PHPMailer/PHPMailer/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="f61TzAYwKYOGnqF6yGv5Oghrx2if01fpVgOBItKPytVlIGVfBjQsa4qIWnw6MO1MpA0SO6vwo6nJoIJaqoD+Uw==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/PHPMailer/PHPMailer/blob/34b33d9e3fd5b08fe2d397dca514058162dbf084/PHPMailerAutoload.php" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/5.0-dev/PHPMailerAutoload.php"
                 data-name="5.0-dev"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/5.0-phpdocs/PHPMailerAutoload.php"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/gh-pages/PHPMailerAutoload.php"
                 data-name="gh-pages"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/longlines/PHPMailerAutoload.php"
                 data-name="longlines"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/master/PHPMailerAutoload.php"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/phpmailer-2.0/PHPMailerAutoload.php"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/phpmailer-2.3.0-msg-limit-patch/PHPMailerAutoload.php"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/phpmailer-5.2.0/PHPMailerAutoload.php"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/qmail/PHPMailerAutoload.php"
                 data-name="qmail"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/smtp-refactor/PHPMailerAutoload.php"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/PHPMailer/PHPMailer/blob/vendor/PHPMailerAutoload.php"
                 data-name="vendor"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a class="octicon-button tooltipped tooltipped-nw js-conduit-openfile-check"
             ...
             data-url="github-mac://openRepo/https://github.com/PHPMailer/PHPMailer?branch=master&amp;filepath=PHPMailerAutoload.php"
             ...
             data-failed-title="Your version of GitHub for Mac is too old to open this file. Try checking for updates.">
              ...
              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 ...
                 href="/PHPMailer/PHPMailer/edit/master/PHPMailerAutoload.php"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/PHPMailer/PHPMailer/delete/master/PHPMailerAutoload.php"
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.05089s from github-fe136-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
